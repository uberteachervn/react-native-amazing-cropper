...
class CropperPage extends Component {
  ...
  getLeftOuterStyle = () => {
    return {
      ...
      height: Animated.add(
        ...
        Animated.add(this.state.bottomPosition.y, Animated.multiply(-1, this.state.topPosition.y))
      ),
  ...
  getTopSideStyle = () => {
    return {
      ...
      width: Animated.add(
        -this.props.BORDER_WIDTH,
        Animated.add(this.state.rightPosition.x, Animated.multiply(-1, this.state.leftPosition.x))
      ),
      paddingBottom: this.props.BORDER_WIDTH
    };
  };
  ...
  onRotate = () => {
    ...
    const startPositionBeforeRotationX =
      this.state.leftPosition.x._value - this.state.LEFT_LIMIT + this.props.BORDER_WIDTH;
    const startPositionBeforeRotationY =
      this.state.topPosition.y._value - this.state.TOP_LIMIT + this.props.BORDER_WIDTH;
    ...
    const rectangleWidthBeforeRotation =
      this.state.rightPosition.x._value - this.state.leftPosition.x._value - this.props.BORDER_WIDTH;
    const rectangleHeightBeforeRotation =
      this.state.bottomPosition.y._value - this.state.topPosition.y._value - this.props.BORDER_WIDTH;
    ...
    const rectangleWidthAfterRotation =
      (imageWidthAfterRotation * rectangleHeightBeforeRotation) / imageHeightBeforeRotation;
    const rectangleHeightAfterRotation =
      (imageHeightAfterRotation * rectangleWidthBeforeRotation) / imageWidthBeforeRotation;
    const startPositionAfterRotationX =
      (startPositionBeforeRotationY * imageWidthAfterRotation) / imageHeightBeforeRotation;
    const startPositionAfterRotationY =
      ((imageWidthBeforeRotation - startPositionBeforeRotationX - rectangleWidthBeforeRotation) *
